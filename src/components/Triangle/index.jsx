...
// --------------------------Set triangle and change angles---------------------------->
  ...
  const anglesOfDefault = (inputs, id, angle) => {
    ...
    var x = parseFloat(180 / Math.PI * window.ggbApplet.getValue(`alpha`)).toFixed(2);
    console.log(x);
    setAngValues([
